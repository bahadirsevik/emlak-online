        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            <div className="rounded-lg bg-white p-6 shadow-sm dark:bg-gray-800">
              ...
              {/* Twitter Share Toggle */}
              <div className="mt-4 flex items-center gap-2 p-3 rounded-lg bg-gradient-to-r from-blue-50 to-sky-50 border border-blue-200 dark:from-blue-900/20 dark:to-sky-900/20 dark:border-blue-800">
                <input
                  type="checkbox"
                  id="shareToTwitter"
                ...
                />
                <label htmlFor="shareToTwitter" className="flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-300">
